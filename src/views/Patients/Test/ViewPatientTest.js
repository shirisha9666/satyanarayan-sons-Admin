                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <div className="page-title-box d-flex align-items-center justify-content-between">
                                <h4 className="mb-3">Patient Test</h4>
                            ...
                            <div className="row ml-0 mr-0 mb-10">
                                ...
                                <div className="col-lg-4">
                                    <label>Patient Name:{patientData[0]?.patient?.name ? patientData[0]?.patient?.name : '-----'}</label>
                                    {/* <input
                                        type="text"
                                    ...
                                    /> */}                                </div>
                                <div className="col-lg-4">
                                    <label>Mobile Number:{patientData[0]?.patient?.mobileNumber ? patientData[0]?.patient?.mobileNumber : '------'}</label>

                                </div>
                                <div className="col-lg-4">
                                    <label>Patient Email:{patientData[0]?.patient?.email ? patientData[0]?.patient?.email : '-----'}</label>
                                        ...
                                        <table className="table  table-bordered mt-3">
                                            ...
                                            <thead className="thead-dark"
                                                ...
                                                <tr>
                                                    ...
                                                    <th className="text-center">Test ON</th>
                                            ...
                                            < tbody >

                                                {
                                                    ...
                                                    ) : patientData?.length > 0 ? (patientData?.map((r, i) =>
                                                    (
                                                        <tr key={i}>
