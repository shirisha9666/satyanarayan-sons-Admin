...
const Leads = () => {
  ...
  const [showData, setShowData] = useState(leadsData);
  ...
  useEffect(() => {
    const loadData = () => {
      ...
      setShowData(leadsData.slice(indexOfFirstPost, indexOfLastPost));
    };
    loadData();
  }, [currentPage, itemPerPage, leadsData]);
                    ...
                    >
                      ...
                      >
                        <tr>
                          ...
                          <th className="text-start">Product Code</th>
                  ...
                  <div className="row mt-20">
                    <div className="col-sm-12 col-md-6 mb-20">
                      ...
                      >
                        ...
                        {Math.min(currentPage * itemPerPage, leadsData.length)}{" "}
                        of {leadsData.length} entries
                      </div>
                    </div>
