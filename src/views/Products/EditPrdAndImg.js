...
const EditPrdAndImg = () => {
  ...
  const getProductDetails = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        // console.log("product shbdhebfhebhfbh", product);
        setData({
          name: product.name,
          master_price: product.master_price,
          master_GST: product.master_GST?._id || "",
        ...
        setImagesPreview({
          main: product.image[0]?.url || "",
          img2: product.image[1]?.url || "",
          img3: product.image[2]?.url || "",
          img4: product.image[3]?.url || "",
        });
  ...
  const removeSelectedColor = (color) => {
    setSelectedColors((prev) =>
      prev.filter((c) => c.colorName !== color.colorName) // Compare by `colorName`
    );
  };
  const handleDetailSubmit = () => {
    ...
    axios
      ...
      .then(() => {
        ...
        swal({
          title: "Saved",
          text: "Product details and media updated successfully!",
          icon: "success",
        });
        navigate("/products");
      })
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="text-center flex-grow-1">Edit Product</h2>
        <div>
          <button
      ...
      >
        ...
        <div className="flex-fill" style={{ flex: "1", paddingLeft: "20px" }}>
          ...
          <h5 className="mb-2">Upload Product Images and Video</h5>
