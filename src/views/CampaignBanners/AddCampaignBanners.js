...
const AddCampaignBanner = () => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(`/api/campaignBanner/create/`, formData, {
        headers: {
      ...
      .then((res) => {
        swal({
          title: "Added",
          text: "campaign Banner added successfully!",
          icon: "success",
          button: "ok",
        });
        setLoading(false);
        navigate("/campaign-banners", { replace: true });
      })
      .catch((err) => {
        setLoading(false);
...
export default AddCampaignBanner;
