...
const AddChapterAndImg = () => {
  ...
  // Predefined colors following the schema
  ...
  // Fetch colors (unchanged, but included for completeness)
  ...
  const removeSelectedColor = (color) => {
    setSelectedColors((prev) =>
      prev.filter((c) => c.colorName !== color.colorName)
    );
  };
  ...
  const handleDetailSubmit = () => {
    ...
    if (
      !data.name.trim() ||
      !data.subject || // Validate subject field
      !data.master_price ||
      !data.genre ||
      !data.sale_price ||
      !data.description ||
      !data.chapter_Status ||
      !images.main // Ensure main image is selected
    ) {
      swal({
        title: "Warning",
        text: "Fill all mandatory fields, including Main Image",
        icon: "warning",
      });
      return;
    }
    ...
    setLoading(true);
    axios
      .post("/api/chapter/create", formData, {
        headers: {
      ...
      .then(() => {
        ...
        swal({
          title: "Saved",
          text: "Chapter details and media saved successfully!",
          icon: "success",
        });
        navigate("/chapters");
      })
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="text-center flex-grow-1">Add Package</h2>
        <div>
          <button
        ...
        >
         ...
         <div className="mb-3">
            <div className="d-flex align-items-center mb-3">
              <label className="col-md-3 col-form-label text-md-end">Package Name</label>
...
export default AddChapterAndImg;
