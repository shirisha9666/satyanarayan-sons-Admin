...
const Chapters = () => {
  ...
  const getSubjects = () => {
   ...
   const packageheading=["Package","GST","Price","TotalPrice","Support","Access","Limit","Status",]
  ...
  const handleDelete = async (id) => {
    ...
    if (confirm === true) {
      const enteredPassword = await swal({
      ...
      const inputfiled = document.querySelector(".swal-content input");
      if (enteredPassword == true && inputfiled?.value) {
        const passwordValue = inputfiled.value;
        let res = axios
          .post(
            `api/chapter/delete/${id}`,
              ...
              >
                ...
                <div className="page-title-right">
                  <Button
                    ...
                    onClick={() => {
                      navigate("/chapter/add", { replace: true });
                    }}
                  >
                    Add Package
                  </Button>
                ...
                <div className="card-body">
                  ...
                  <div className="table-responsive table-shoot mt-3">
                    ...
                    >
                      ...
                      >
                        <tr>
                          {packageheading.map((item)=><th className="text-start" key={item}>{item}</th>)}
                                ...
                                <td className="text-start">
                                  ...
                                  {chapter?.variants?.length > 0
                                    ? chapter.variants[0].gst_Id?.active
                                      ...
                                      : chapter.variants[0].price.toLocaleString(
                                          "en-IN",
                                          {
                                            minimumFractionDigits: 2,
                                            maximumFractionDigits: 2,
                                    ...
                                    : chapter.master_price.toLocaleString(
                                        "en-IN",
                                        {
                                          minimumFractionDigits: 2,
                                          maximumFractionDigits: 2,
